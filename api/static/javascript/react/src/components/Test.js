...
import {getConceptLoop} from "../api/values.js";
...
const Test = () => {
  const value = window.location.search ? parseInt(new URLSearchParams(window.location.search).get("search")) : 23145;
  ...
  const handleSubmit = (id, concept) => {
    if (concept === "") {
      ...
      const value2 = res.data.find((f) => f.id === id);
      const newArr = value2.conceptIds.concat(concept);
      api.put(`/values/${id}`, {
        id: {id},
        value: value2.value,
        frequency: value2.frequency,
        conceptIds: newArr
  ...
  const handleDelete = (id, conceptId) => {
    const value2 = res.data.find((f) => f.id === id);
    const concept = value2.conceptIds.filter((item) => item !== conceptId);
    api.put(`/values/${id}`, {
      id: {id},
      value: value2.value,
      frequency: value2.frequency,
  ...
  if (res1.isLoading || res1.isError) {
    ...
    }, /* @__PURE__ */ React.createElement(TableCaption, null), /* @__PURE__ */ React.createElement(Thead, null, /* @__PURE__ */ React.createElement(Tr, null, /* @__PURE__ */ React.createElement(Th, null, "Value"), /* @__PURE__ */ React.createElement(Th, null, "Value Description"), /* @__PURE__ */ React.createElement(Th, null, "Frequency"), /* @__PURE__ */ React.createElement(Th, null, "Concepts"), /* @__PURE__ */ React.createElement(Th, null))), /* @__PURE__ */ React.createElement(Tbody, null, res1.data.map((item, index) => /* @__PURE__ */ React.createElement(Tr, {
      key: item.id
    }, /* @__PURE__ */ React.createElement(Td, null, item.value), /* @__PURE__ */ React.createElement(Td, null, item.value_description), /* @__PURE__ */ React.createElement(Td, null, item.frequency), /* @__PURE__ */ React.createElement(Td, null, concepts.length > 0 ? concepts[index].length > 0 && /* @__PURE__ */ React.createElement(VStack, {
