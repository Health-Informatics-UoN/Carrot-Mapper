...
export default function Demo2() {
  return (
    <>
      {/* Hero section */}
      <div className="flex-col lg:grid lg:grid-cols-2 lg:flex items-center justify-center overflow-hidden lg:px-24 lg:py-20 p-5">
      ...
      {/* <div className="relative flex w-full items-center justify-center overflow-hidden rounded-lg border bg-background p-20 md:shadow-xl">
        <div className="flex flex-col lg:space-y-5 space-y-3">
          <div className="lg:text-5xl text-3xl gap-5 text-center lg:text-left">
            <h1 className="text-orange-600">OMOP Transforming </h1>
            <h1> Made Easy</h1>
