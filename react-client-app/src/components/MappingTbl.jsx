                ...
                <Tbody>
                    {values.length>0?
                        ...
                        <Tr key={index}>
                            ...
                            <Td><Link style={{color:"#0000FF",}} href={api+"/fields/?search="+item.source_field.scan_report_table.id}>{item.source_field?item.source_field.scan_report_table.name:null}</Link></Td>
                            <Td><Link style={{color:"#0000FF",}} href={api+"/values/?search="+item.source_field.id}>{item.source_field?item.source_field.name:null}</Link></Td>
                            <Td>
                                {item.scanreport&&
                                <VStack>
