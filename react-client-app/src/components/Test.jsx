...
import { getConceptLoop }  from '../api/values'
...
const Test = () => {
    ...
    useEffect(() => {
        ...
        .then(result=>{
                ...
                // to make sure that everything has been run before setting the state, make a list of lists
                // that has the number that still needs to load. Every time something loads, it pushes one 
                // out. When the list becomes empty, everything has loaded so you can set the concepts.
