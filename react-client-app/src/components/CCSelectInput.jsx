...
const CCSelectInput = (props) => {
  ...
  return (
    <FormControl
      isInvalid={props.formErrors && props.formErrors.length > 0}
      mt={4}
    >
      <FormLabel htmlFor={props.id} w="200px" style={{ fontWeight: "bold" }}>
        {props.label}
      </FormLabel>
      <Select
        value={props.value}
        onChange={(option) => props.handleInput(option.target.value)}
